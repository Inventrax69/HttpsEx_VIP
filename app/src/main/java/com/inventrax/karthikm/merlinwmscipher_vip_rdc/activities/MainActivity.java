...
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.CycleCountDetailsFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.CycleCountHeaderFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.DeleteOBDPickedItemsFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.DeleteVLPDPickedItemsFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.DrawerFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.GoodsInFragment;
...
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.LoadGenerationFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.LoadSheetFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.LoadingFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.MaterialTransferFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.NewLoadSheetFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.OBDPickingDetailsFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.OBDPickingHeaderFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.OutboundRevertDetailsFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.OutboundRevertHeaderFragment;
...
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.PickingDetailsFragment;
...
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.VLPDPickingDetailsFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.fragments.VLPDPickingHeaderFragment;
import com.inventrax.karthikm.merlinwmscipher_vip_rdc.interfaces.ScanKeyListener;
        ...
        if (ScannedData != null) {
            ...
            for (final Fragment fragment : fragmentManager.getFragments()) {
                ...
                if (fragment != null && fragment.isVisible() && fragment instanceof PickingDetailsFragment) {
                    ((PickingDetailsFragment) fragment).myScannedData(MainActivity.this, ScannedData);
                }
                if (fragment != null && fragment.isVisible() && fragment instanceof PickingHeaderFragment) {
                    ((PickingHeaderFragment) fragment).myScannedData(MainActivity.this, ScannedData);
                }
            }
        }
